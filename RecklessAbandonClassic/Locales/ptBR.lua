...
L["You have installed a version of this addon intended for |cFFFFFAB8%s|r, however you are currently playing |cFFFFFAB8%s|r. You may encounter serious issues with this setup. Please install the proper version from Github, CurseForge, or WoWInterface, and restart the game."] =
    "Você instalou uma versão deste addon destinada a |cFFFFFAB8%s|r, porém você está jogando atualmente como |cFFFFFAB8%s|r. Você pode encontrar problemas sérios com essa configuração. Por favor, instale a versão adequada no Github, CurseForge, ou WoWInterface, e reinicie o jogo."
...
L["Written by |T626001:0|t |cFF3FC7EB%s|r aka |T626003:0|t |cFFF48CBAAllyïa-Mankrik (US)|r"] = "Escrito por |T626001:0|t |cFF3FC7EB%s|r também conhecido como |T626003:0|t |cFFF48CBAAllyïa-Mankrik (US)|r"
