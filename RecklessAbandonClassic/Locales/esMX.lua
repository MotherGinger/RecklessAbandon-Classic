...
L["Ajusta la cantidad de mensajes que recibirás de las acciones realizadas en tu registro de misiones.\n\n|cFF00D1FFNota:|r Siempre se te notificará cuando se abandone una misión en tu nombre."] = true
...
L["Automatically abandon quests of the given type if they are included in group abandons.\n\n|cFFFF6B6BCaution:|r These quests will be abandoned for you, confirmation settings will be ignored."] = "Abandonar automáticamente las misiones del tipo dado si están incluidas en los abandonos grupales.\n\n|cFFFF6B6BCaution:|r Estas misiones se abandonarán por ti, la configuración de confirmación se ignorará"
...
L["Written by |T626001:0|t |cFF3FC7EB%s|r aka |T626003:0|t |cFFF48CBAAllyïa-Mankrik (US)|r"] = "Escrito por |T626001:0|t |cFF3FC7EB%s|r aka |T626003:0|t |cFFF48CBAAllyïa-Mankrik (US)|r"
